...
module.exports = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            // Use gemini-pro (Legacy Stable) on v1 endpoint
            const response2 = await fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-pro:generateContent?key=${GEMINI_API_KEY}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    contents: [{
