...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const instruction = userPrompt || "Edit the uploaded photo without redrawing it. Preserve the original photo’s lighting, shadows, highlights, grain, reflections, lens distortion, camera angle, perspective, textures, and all photographic details exactly as they appear. Make only subtle, photorealistic adjustments to materials and finishes. Do NOT repaint, re-render, stylize, smooth, or recreate the image. Do NOT introduce any illustration, CGI, drawing, or synthetic textures. Retain every pixel of the original image except where specific edits are applied. Make small, realistic upgrades to surface materials (such as walls, cabinetry, fixtures, flooring, countertops) while keeping the original structure and layout unchanged. Remove clutter and non-structural objects only, keeping the background untouched. Final output must look like an unedited real photograph, not a rendering, drawing, or AI-generated image.";
