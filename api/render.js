...
module.exports = async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            // Use gemini-1.5-flash (Stable) on v1 endpoint
            const response2 = await fetch(`https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${GEMINI_API_KEY}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    contents: [{
