...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const instruction = userPrompt || "Make subtle, photorealistic improvements to the uploaded image without changing the camera angle, perspective, framing, lighting direction, or overall structure. Preserve all architectural geometry exactly as it appears. Do not redraw or re-render the scene. Keep every permanent element in the same position: walls, windows, ceilings, doors, floors, and layout. Update only the materials and surface finishes to look clean, modern, and newly renovated. Apply realistic textures and lighting that match the original photograph. Replace outdated finishes with modern equivalents, but preserve the original shapes, contours, and proportions. Remove small items, clutter, or obstructing objects while keeping the environment natural and believable — as if the same photo was taken after a real renovation. No stylization, no sketch effects, no illustration aesthetics. Final result must be a photorealistic photograph, not a 3D render, drawing, or painting.";
