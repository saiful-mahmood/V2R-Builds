const translations = {
    en: {
        ...
        diff_title: "What Makes V2R Different",
        diff_1: "Built by contractors, not software companies",
        diff_2: "Real labor logic — hours, crews, productivity",
        ...
        perfect_3: "Small to mid-size crews (1–10 people)",
    ...
    pt: {
        ...
        stat_1_sub: "Do walkthrough à proposta — na mesma visita",
        stat_2_value: "47%",
        stat_2_text: "Mais negócios fechados",
        stat_2_sub: "Apresentando orçamentos no local",
        stat_3_value: "2–4 hrs",
        stat_3_text: "Economizadas por orçamento",
        stat_3_sub: "Sem vai-e-vem, sem orçamentos à noite",
        how_it_works_title: "Como Funciona",
        step_1_title: "Grave o Seu Walk-Through",
        step_1_desc: "Escolha o tipo de projeto e o escopo.",
        step_2_title: "Ajuste Mão de Obra e Materiais",
        step_2_desc: "Modifique horas, equipe e materiais em tempo real.",
        step_3_title: "Envie um Orçamento Profissional",
        step_3_desc: "Compartilhe instantaneamente um PDF com a sua marca para o cliente.",
        diff_title: "O Que Torna a V2R Diferente",
        diff_1: "Criado por empreiteiros, não empresas de software",
        diff_2: "Lógica real de trabalho — horas, equipes, produtividade",
        diff_3: "Lógica de preços transparente (sem caixa-preta de IA)",
        diff_4: "Projetado para Empreiteiros Gerais e reformadores residenciais",
        diff_5: "Focado em vendas, não apenas software de orçamento",
        ...
        perfect_3: "Equipes pequenas e médias (1–10 pessoas)",
        not_for: "<i class=\"fa-solid fa-xmark-circle\"></i> Não É Para",
        not_1: "Grandes projetos comerciais",
        not_2: "Firmas de engenharia",
        not_3: "Departamentos de orçamento corporativos",
        contact_title: "Veja quão rápidos seus orçamentos podem ser!",
        label_name: "Nome",
        ...
        footer_rights: "© 2025 V2R Builds. Todos os direitos reservados.",
        modal_title: "Comece Seu Projeto",
        modal_step1_q: "Que tipo de projeto você está planejando?",
        modal_step2_q: "Conte-nos um pouco mais sobre sua visão.",
        modal_step2_placeholder: "Quais são seus objetivos? Você tem um prazo em mente?",
    ...
    es: {
        ...
        stat_1_sub: "Del recorrido a la propuesta — en la misma visita",
        stat_2_value: "47%",
        stat_2_text: "Más tratos cerrados",
        stat_2_sub: "Presentando presupuestos en el sitio",
        stat_3_value: "2–4 horas",
        ...
        step_3_title: "Envía un Presupuesto Profesional",
        step_3_desc: "Comparte al instante un PDF con tu marca con el cliente.",
        diff_title: "Qué Hace a V2R Diferente",
        diff_1: "Construido por contratistas, no empresas de software",
        diff_2: "Lógica laboral real — horas, equipos, productividad",
        diff_3: "Lógica de precios transparente (sin caja negra de IA)",
        diff_4: "Diseñado para Contratistas Generales residenciales y remodeladores",
        ...
        perfect_3: "Equipos pequeños a medianos (1–10 personas)",
        not_for: "<i class=\"fa-solid fa-xmark-circle\"></i> No Es Para",
        not_1: "Grandes proyectos comerciales",
        not_2: "Firmas de ingeniería",
        not_3: "Departamentos de presupuesto corporativos",
        contact_title: "¡Mira qué rápidos pueden ser tus presupuestos!",
        label_name: "Nombre",
        ...
        footer_rights: "© 2025 V2R Builds. Todos los derechos reservados.",
        modal_title: "Comienza Tu Proyecto",
        modal_step1_q: "¿Qué tipo de proyecto estás planeando?",
        modal_step2_q: "Cuéntanos un poco más sobre tu visión.",
        modal_step2_placeholder: "¿Cuáles son tus objetivos? ¿Tienes un plazo en mente?",
        modal_step3_q: "¿Cómo podemos contactarte?",
        btn_back: "Atrás",
        btn_next: "Siguiente",
        opt_kitchen: "Remodelación de Cocina",
        opt_bathroom: "Renovación de Baño",
